...
var DualKey = 'shshshfpa=92db719c-7a57-49d6-818f-4cacea98a991-1628218985; shshshfpb=aeVxcm%2FcbzIH16z6Q%2FMZOmg%3D%3D; __jdu=16282183416531105755973; areaId=27; ipLoc-djd=27-2376-0-0; PCSYCityID=CN_610000_610100_0; unpl=; shshshfp=f8d1fd38b9cedebb2f72f45c9a9d8c51; TrackID=1u1hKBFMdjxVCI_bZVETKwy5tqxEvnliiMoZOsfYfeu2yFZHi617W3hA0lY_kjYIRbkZPijzLqPpfES4H4KD_-tnB9jucGSO65oaeba1qEAs; thor=; pinId=-QYIJ0usfIwEYRG0Tw4D3g; pin=jd_ZCvcIYlOdtDz; unick=jd_ZCvcIYlOdtDz; ceshi3.com=000; _tp=8B949RlBNkCa5Q%2Fpxo4oqA%3D%3D; _pst=jd_ZCvcIYlOdtDz; __jdv=76161171|baidu-pinzhuan|t_288551095_baidupinzhuan|cpc|0f3d30c8dba7459bb52f2eb5eba8ac7d_0_c121fd381f354e45b7ab73f533104d56|1644373106424; shshshsID=6beb43808223206913a80134eba70f78_16_1644373107342; __jda=122270672.16282183416531105755973.1628218341.1644372958.1644373077.9; __jdc=122270672; 3AB9D23F7A4B3C9B=LF3CDS2XFL3GDMZAU5POIVNNSL5OXT7EKYAYHH7EYAOPOGBIKN7BWDECDCZI4OHZJMQ3PWNZSZL4NZTBBEUEBDM46E; __jdb=122270672.6.16282183416531105755973|9.1644373077'; //如需双账号签到,此处单引号内填写抓取的"账号2"Cookie, 否则请勿填写
    ...
    case 0:
      ...
      await Promise.all([
        ...
        JDUserSignPre(
          ...
          'JDSubsidy',
          '京东晚市-补贴',
          'xK148m4kWj5hBcTPuJUNNXH3AkJ'
        ), //京东晚市补贴金
        JDUserSignPre(
          stop,
          'JDDrug',
          '京东商城-医药',
          '3tqTG5sF1xCUyC6vgEF5CLCxGn7w'
        ), //京东医药馆
        JDUserSignPre(
          stop,
          'JDWomen',
      ...
      await Promise.all([
        ...
        JDUserSignPre(
          ...
          'JDCare',
          '京东商城-个护',
          'NJ1kd1PJWhwvhtim73VPsD1HwY3'
        ), //京东个人护理馆
        JDUserSignPre(
          stop,
          'JDJewels',
          '京东商城-珠宝',
          'zHUHpTHNTaztSRfNBFNVZscyFZU'
        ), //京东珠宝馆
        JDUserSignPre(
          stop,
          'JDClocks',
          '京东商城-钟表',
          '2BcJPCVVzMEtMUynXkPscCSsx68W'
        ), //京东钟表馆
        JDUserSignPre(
          stop,
          'JDMakeup',
          '京东商城-美妆',
          '2smCxzLNuam5L14zNJHYu43ovbAP'
        ), //京东美妆馆
        JDUserSignPre(
          stop,
          'JDVege',
    ...
    try {
      ...
      $nobyda.notify(
        ...
        Name + one + two + three + four + five + disa + notify,
        {
          'media-url':
            $nobyda.headUrl ||
            'https://cdn.jsdelivr.net/gh/Orz-3/task@master/jd.png',
        }
      );
      $nobyda.headUrl = null;
      if ($nobyda.isJSBox) {
...
function JingDongTurn(s) {
  ...
  return new Promise((resolve, reject) => {
    ...
    const JDTUrl = {
      url:
        'https://api.m.jd.com/client.action?functionId=wheelSurfIndex&body=%7B%22actId%22%3A%22jgpqtzjhvaoym%22%2C%22appSource%22%3A%22jdhome%22%7D&appid=ld',
      headers: {
        Cookie: KEY,
      },
    };
  ...
  return new Promise((resolve) => {
    ...
    setTimeout(() => {
      const login = {
        ...
        body:
          'reqData=%7B%22channelCode%22%3A%22ZHUANQIAN%22%2C%22clientType%22%3A%22sms%22%2C%22clientVersion%22%3A%2211.0%22%7D',
      };
  ...
  return new Promise((resolve) => {
    ...
    setTimeout(() => {
      const JRSUrl = {
        ...
        body:
          'reqData=%7B%22channelSource%22%3A%22JRAPP6.0%22%2C%22riskDeviceParam%22%3A%22%7B%7D%22%7D',
      };
...
function JingDongShake(s) {
  ...
  return new Promise((resolve) => {
    ...
    setTimeout(() => {
      const JDSh = {
        url:
          'https://api.m.jd.com/client.action?appid=vip_h5&functionId=vvipclub_shaking',
        headers: {
          Cookie: KEY,
        },
      };
  ...
  return new Promise((resolve) => {
    ...
    setTimeout(() => {
      const JDPETUrl = {
        ...
        body:
          'body=%7B%22version%22%3A%22v2%22%7D&client=apple&clientVersion=9.0.8&openudid=1fce88cd05c42fe2b054e846f11bdf33f016d676&sign=6768e2cf625427615dd89649dd367d41&st=1597248593305&sv=121',
      };
  ...
  return new Promise((resolve) => {
    setTimeout(() => {
      const Url = {
        ...
        body:
          'body=%7B%22version%22%3A%22v2%22%7D&client=apple&clientVersion=9.0.8&openudid=1fce88cd05c42fe2b054e846f11bdf33f016d676&sign=49baa3b3899b02bbf06cdf41fe191986&st=1597682588351&sv=111',
      };
  ...
  return new Promise((resolve) => {
    ...
    setTimeout(() => {
      const JDCAUrl = {
        ...
        body:
          'body=%7B%22pageClickKey%22%3A%22CouponCenter%22%2C%22eid%22%3A%22O5X6JYMZTXIEX4VBCBWEM5PTIZV6HXH7M3AI75EABM5GBZYVQKRGQJ5A2PPO5PSELSRMI72SYF4KTCB4NIU6AZQ3O6C3J7ZVEP3RVDFEBKVN2RER2GTQ%22%2C%22shshshfpb%22%3A%22v1%5C%2FzMYRjEWKgYe%2BUiNwEvaVlrHBQGVwqLx4CsS9PH1s0s0Vs9AWk%2B7vr9KSHh3BQd5NTukznDTZnd75xHzonHnw%3D%3D%22%2C%22childActivityUrl%22%3A%22openapp.jdmobile%253a%252f%252fvirtual%253fparams%253d%257b%255c%2522category%255c%2522%253a%255c%2522jump%255c%2522%252c%255c%2522des%255c%2522%253a%255c%2522couponCenter%255c%2522%257d%22%2C%22monitorSource%22%3A%22cc_sign_ios_index_config%22%7D&client=apple&clientVersion=8.5.0&d_brand=apple&d_model=iPhone8%2C2&openudid=1fce88cd05c42fe2b054e846f11bdf33f016d676&scope=11&screen=1242%2A2208&sign=1cce8f76d53fc6093b45a466e93044da&st=1581084035269&sv=102',
      };
        ...
        try {
          if (error) {
            ...
            if (cc.message == 'not login') {
              ...
              if (data.match(/领过此任务/)) {
                //处理任务频繁问题
                if (!$nobyda.tryAgain || $nobyda.tryAgain < 3) {
                  //避免死循环
                  $nobyda.tryAgain
                    ? ($nobyda.tryAgain += 1)
                    : ($nobyda.tryAgain = 1);
...
function JDQueryTask(s) {
  return new Promise((resolve) => {
    setTimeout(() => {
      ...
      const QueryUrl = {
        url:
          'https://api.m.jd.com/?appid=memberTaskCenter&functionId=energyProp_list&body=%7B%22source%22%3A%22game%22%7D',
        headers: {
          Referer:
            'https://h5.m.jd.com/babelDiy/Zeus/6yCQo2eDJPbyPXrC3eMCtMWZ9ey/index.html',
          Cookie: KEY,
...
function JDQueryTaskID(s) {
  return new Promise((resolve) => {
    ...
    setTimeout(() => {
      const EUrl = {
        url:
          'https://api.m.jd.com/?appid=memberTaskCenter&functionId=energyProp_usalbeList&body=%7B%22source%22%3A%22game%22%7D',
        headers: {
          Referer:
            'https://h5.m.jd.com/babelDiy/Zeus/6yCQo2eDJPbyPXrC3eMCtMWZ9ey/index.html',
          Cookie: KEY,
          ...
          (error, response, data) => {
            try {
              ...
              if (error) {
                ...
                const Details = LogDetails ? 'response:\n' + data : '';
                console.log(
                  `\n天天加速-尝试使用第${$nobyda.PropCount}个道具 (${
                    s / 1000
                  }s)${Details}`
                );
  ...
  return new Promise((resolve) => {
    ...
    setTimeout(() => {
      const OverseasUrl = {
        ...
        body:
          'body=%7B%7D&build=167237&client=apple&clientVersion=9.0.0&openudid=1fce88cd05c42fe2b054e846f11bdf33f016d676&partner=apple&scope=11&sign=e27f8b904040a0e3c99b87fc27e09c87&st=1591730990449&sv=101',
      };
...
function JingDongGetCash(s) {
  ...
  return new Promise((resolve) => {
    ...
    setTimeout(() => {
      const GetCashUrl = {
        url:
          'https://api.m.jd.com/client.action?functionId=cash_sign&body=%7B%22remind%22%3A0%2C%22inviteCode%22%3A%22%22%2C%22type%22%3A0%2C%22breakReward%22%3A0%7D&client=apple&clientVersion=9.0.8&openudid=1fce88cd05c42fe2b054e846f11bdf33f016d676&sign=7e2f8bcec13978a691567257af4fdce9&st=1596954745073&sv=111',
        headers: {
          Cookie: KEY,
        },
      };
        ...
        (error, response, data) => {
          try {
            ...
            if (cc.code == 0 && cc.subCode == 0) {
              ...
              merge.JDWebcasts.notify = `京东商城-直播: 成功, 明细: ${
                merge.JDWebcasts.bean || `无`
              }京豆 🐶`;
            } else {
              console.log(`\n京东商城-直播签到失败 ${Details}`);
              const tp = data.match(/擦肩而过/)
                ? `无机会`
                : cc.code == 3
                ? `Cookie失效`
                : `${cc.msg || `未知`}`;
              merge.JDWebcasts.notify = `京东商城-直播: 失败, 原因: ${tp}${
                cc.code == 3 ? `‼️` : ` ⚠️`
              }`;
  ...
  return new Promise((resolve) => {
    ...
    setTimeout(() => {
      $nobyda.get(
        {
          url:
            'https://api.m.jd.com/client.action?functionId=discTaskList&body=%7B%22bizType%22%3A1%2C%22referPageId%22%3A%22discRecommend%22%7D&client=apple&clientVersion=9.1.6&openudid=1fce88cd05c42fe2b054e846f11bdf33f016d676&sign=17061147fe8e0eb10edfe8d9968b6d66&st=1601138337675&sv=102',
          headers: {
            Cookie: KEY,
          },
        },
        (error, response, data) => {
          try {
            ...
            if (data.match(/签到成功/) && !data.match(tm)) {
              ...
              merge.TakeaLook.notify = `京东发现-看看: 成功, 明细: ${
                merge.TakeaLook.bean || `无`
              }京豆 🐶`;
            } else {
              console.log(`\n京东发现-看看签到失败 ${Details}`);
              const tp = data.match(tm)
                ? `已签过`
                : cc.busiCode == 2001
                ? `Cookie失效`
                : `${cc.message || `未知`}`;
              merge.TakeaLook.notify = `京东发现-看看: 失败, 原因: ${tp}${
                cc.busiCode == 2001 ? `‼️` : ` ⚠️`
              }`;
  ...
  return new Promise((resolve) => {
    ...
    setTimeout(() => {
      $nobyda.get(
        {
          url:
            'https://api.m.jd.com/api?appid=jdsupermarket&functionId=smtg_sign&clientVersion=8.0.0&client=m&body=%7B%7D',
          headers: {
            Cookie: KEY,
      ...
      $nobyda.post(
        {
          ...
          body:
            'functionId=freshManHomePage&body=%7B%7D&client=wh5&appid=SecKill2020',
        },
        (error, response, data) => {
          try {
            if (error) throw new Error(error);
...
function JRLuckyLottery(s) {
  //https://jdda.jd.com/app/hd/#/turntable
  merge.JRLottery = {};
  return new Promise((resolve) => {
      ...
      $nobyda.post(
        {
          ...
          body: `reqData=${encodeURIComponent(
            `{"activityNo":"e2d1b240d5674def8178be6b4faac5b6","signType":"1","encryptSign":""}`
          )}`,
        },
        (error, response, data) => {
          try {
            ...
            if (
              cc.resultCode == 0 &&
              cc.resultData &&
              cc.resultData.resultCode == 0
            ) {
              console.log(`\n京东金融-抽奖签到成功 ${Details}`);
              merge.JRLottery.success = 1;
              merge.JRLottery.bean =
                cc.resultData.data.rewardList[0].rewardCount || 0;
              merge.JRLottery.notify = `京东金融-抽奖: 成功, 明细: ${
                merge.JRLottery.bean || `无`
              }京豆 🐶`;
            } else {
              console.log(`\n京东金融-抽奖签到失败 ${Details}`);
              const tp = data.match(/重复签到/)
                ? `已签过`
                : cc.resultCode == 3
                ? `Cookie失效`
                : `${cc.resultMsg || `未知`}`;
              merge.JRLottery.notify = `京东金融-抽奖: 失败, 原因: ${tp}${
                cc.resultCode == 3 ? `‼️` : ` ⚠️`
              }`;
        ...
        (error, response, data) => {
          try {
            ...
            if (cc.status && cc.data && cc.data.firstLoginStatus) {
              ...
              const qt =
                cc.status && cc.data && cc.data.firstLoginStatus === false
                  ? `已签过`
                  : cc.error && cc.error.code == 2000
                  ? `Cookie失效`
                  : cc.error && cc.error.msg
                  ? cc.error.msg
                  : `未知`;
              merge.JDBuyCar.notify = `京东商城-汽车: 失败, 原因: ${qt}${
                cc.error && cc.error.code == 2000 ? `‼️` : ` ⚠️`
              }`;
          ...
          (error, response, data) => {
            try {
              ...
              if (cc.status === true) {
                ...
                merge.JDBuyCar.bean =
                  cc.data && cc.data.beanNum ? cc.data.beanNum : 0;
                merge.JDBuyCar.notify = `京东商城-汽车: 成功, 明细: ${
                  merge.JDBuyCar.bean || `无`
                }京豆 🐶`;
              } else {
                console.log(`\n京东商城-汽车签到失败 ${Details}`);
                merge.JDBuyCar.fail = 1;
                merge.JDBuyCar.notify = `京东商城-汽车: 失败, ${
                  cc.error && cc.error.msg ? cc.error.msg : `原因: 未知`
                } ⚠️`;
              }
            } catch (eor) {
    ...
    $nobyda.post(
      {
        ...
        body:
          'body=%7B%22fp%22%3A%22-1%22%2C%22appToken%22%3A%22apphongbao_token%22%2C%22childActivityUrl%22%3A%22-1%22%2C%22country%22%3A%22cn%22%2C%22openId%22%3A%22-1%22%2C%22childActivityId%22%3A%22-1%22%2C%22applicantErp%22%3A%22-1%22%2C%22platformId%22%3A%22appHongBao%22%2C%22isRvc%22%3A%22-1%22%2C%22orgType%22%3A%222%22%2C%22activityType%22%3A%221%22%2C%22shshshfpb%22%3A%22-1%22%2C%22platformToken%22%3A%22apphongbao_token%22%2C%22organization%22%3A%22JD%22%2C%22pageClickKey%22%3A%22-1%22%2C%22platform%22%3A%221%22%2C%22eid%22%3A%22-1%22%2C%22appId%22%3A%22appHongBao%22%2C%22childActiveName%22%3A%22-1%22%2C%22shshshfp%22%3A%22-1%22%2C%22jda%22%3A%22-1%22%2C%22extend%22%3A%22-1%22%2C%22shshshfpa%22%3A%22-1%22%2C%22activityArea%22%3A%22-1%22%2C%22childActivityTime%22%3A%22-1%22%7D&client=apple&clientVersion=8.5.0&d_brand=apple&networklibtype=JDNetworkBaseAF&openudid=1fce88cd05c42fe2b054e846f11bdf33f016d676&sign=fdc04c3ab0ee9148f947d24fb087b55d&st=1581245397648&sv=120',
      },
      (error, response, data) => {
        try {
          if (error) throw new Error(error);
...
function TotalMoney() {
  ...
  return new Promise((resolve) => {
    ...
    $nobyda.get(
      {
        url:
          'https://api.m.jd.com/client.action?functionId=cash_exchangePage&body=%7B%7D&build=167398&client=apple&clientVersion=9.1.9&openudid=1fce88cd05c42fe2b054e846f11bdf33f016d676&sign=762a8e894dea8cbfd91cce4dd5714bc5&st=1602179446935&sv=102',
        headers: {
          Cookie: KEY,
        },
      },
  ...
  try {
    if ($request.headers && $request.url.match(/api\.m\.jd\.com.*=signBean/)) {
      ...
      if (CV.match(/pt_key=.+?;/) && CV.match(/pt_pin=.+?;/)) {
        var CookieValue =
          CV.match(/pt_key=.+?;/)[0] + CV.match(/pt_pin=.+?;/)[0];
